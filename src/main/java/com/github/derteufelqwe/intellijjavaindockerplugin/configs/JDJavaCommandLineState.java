...
import com.github.derteufelqwe.intellijjavaindockerplugin.utiliity.TargetDebuggerConnection;
...
public abstract class JDJavaCommandLineState extends CommandLineState implements JavaCommandLine, TargetEnvironmentAwareRunProfileState, RemoteConnectionCreator {
    ...
    protected JDJavaCommandLineState(@NotNull ExecutionEnvironment environment) {
        super(environment);
    }
